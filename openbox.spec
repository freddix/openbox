...
install %{SOURCE10} %{SOURCE11} $RPM_BUILD_ROOT%{_prefix}/lib/systemd/user
...
# systemd user session
%{_prefix}/lib/systemd/user/openbox.target
%{_prefix}/lib/systemd/user/openboxwm.service
